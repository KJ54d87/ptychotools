...
frames = 24
contrast_function = intensity_contrast  #Options are(will be) Michelsons, RMS, max_intensity
size = 480 
...
with Image.open(IMG) as sample:
    ...
    for i in range()
    mesh = generate_mesh(4, 290, 293, 13.7, 2.9, 0, 1, 13.7, 111.7, -15, 5)
    ...
    #generare numpy list
    circles = [generate_circle_mesh(mesh[i][0], mesh[i][1], 5) for i in range(len(mesh))] 
